...
var WeightsEditDialog = (function (_super) {
    ...
    WeightsEditDialog.prototype.build = function (node) {
        ...
        node.insertAdjacentHTML('beforeend', "<div>\n        " + this.weights.map(function (weight, i) { return "<div><input type=\"number\" value=\"" + round(weight * 100, 2) + "\" min=\"0\" max=\"100\" step=\"any\"><span><span style=\"background-color: " + children[i].color + "; width: " + round(weight * 100, 2) + "%\"></span></span>" + children[i].label + "</div>"; }).join('') + "\n    </div>");

...
export function createData(col, context, stacked, mode, imposer) {
...
var MultiLevelCellRenderer = (function (_super) {
    ...
    MultiLevelCellRenderer.prototype.create = function (col, context, _hist, imposer) {
        var _a = createData(col, context, this.stacked, ERenderMode.CELL, imposer), cols = _a.cols, stacked = _a.stacked, padding = _a.padding;
    ...
    MultiLevelCellRenderer.prototype.createGroup = function (col, context, hist, imposer) {
        ...
        var _a = createData(col, context, false, ERenderMode.GROUP, imposer), cols = _a.cols, padding = _a.padding;
        var useGrid = context.option('useGridLayout', false);
        return {

...
import { compareBoxPlot, ESortMethod, getBoxPlotNumber, noNumberFilter } from './INumberColumn';
...
var BoxPlotColumn = (function (_super) {
    ...
    BoxPlotColumn.prototype.createEventList = function () {
        return _super.prototype.createEventList.call(this).concat([BoxPlotColumn_1.EVENT_SORTMETHOD_CHANGED, BoxPlotColumn_1.EVENT_COLOR_MAPPING_CHANGED, BoxPlotColumn_1.EVENT_MAPPING_CHANGED]);
    };
    ...
    BoxPlotColumn.EVENT_SORTMETHOD_CHANGED = 'sortMethodChanged';

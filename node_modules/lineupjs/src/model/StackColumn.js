...
var StackColumn = (function (_super) {
    ...
    function StackColumn(id, desc) {
        ...
        _this.setDefaultRenderer('stack');
        _this.setDefaultGroupRenderer('stack');
        _this.setDefaultSummaryRenderer('default');
        return _this;
    }
    ...
    StackColumn.prototype.adaptWidthChange = function (col, oldValue, newValue) {
        ...
        this.fire([StackColumn_1.EVENT_WEIGHTS_CHANGED, StackColumn_1.EVENT_MULTI_LEVEL_CHANGED, Column.EVENT_DIRTY_HEADER, Column.EVENT_DIRTY_VALUES, Column.EVENT_DIRTY], bak, this.getWeights());
    };
    ...
    StackColumn.prototype.setWeights = function (weights) {
        ...
        this.fire([StackColumn_1.EVENT_WEIGHTS_CHANGED, StackColumn_1.EVENT_MULTI_LEVEL_CHANGED, Column.EVENT_DIRTY_HEADER, Column.EVENT_DIRTY_VALUES, Column.EVENT_DIRTY], bak, weights);
    };
    ...
    StackColumn.prototype.isMissing = function (row) {
        return this._children.some(function (c) { return isNumberColumn(c) && c.isMissing(row); });
    };

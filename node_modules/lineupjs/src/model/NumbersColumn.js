...
import { compareBoxPlot, DEFAULT_FORMATTER, EAdvancedSortMethod, getBoxPlotNumber, noNumberFilter } from './INumberColumn';
...
var NumbersColumn = (function (_super) {
    ...
    function NumbersColumn(id, desc) {
        ...
        _this.colorMapping = restoreColorMapping(_this.color, desc);
    ...
    NumbersColumn.prototype.createEventList = function () {
        return _super.prototype.createEventList.call(this).concat([NumbersColumn_1.EVENT_COLOR_MAPPING_CHANGED, NumbersColumn_1.EVENT_MAPPING_CHANGED, NumbersColumn_1.EVENT_SORTMETHOD_CHANGED]);
    };

...
var Ranking = (function (_super) {
    ...
    Ranking.prototype.insert = function (col, index) {
        ...
        col.attach(this);
        this.forward.apply(this, [col].concat(suffix('.ranking', Column.EVENT_DIRTY_VALUES, Column.EVENT_DIRTY_HEADER, Column.EVENT_DIRTY, NumberColumn.EVENT_FILTER_CHANGED)));
    ...
    Ranking.prototype.remove = function (col) {
        ...
        this.unforward.apply(this, [col].concat(suffix('.ranking', Column.EVENT_VISIBILITY_CHANGED, Column.EVENT_DIRTY_VALUES, Column.EVENT_DIRTY_HEADER, Column.EVENT_DIRTY, NumberColumn.EVENT_FILTER_CHANGED)));
    ...
    Ranking.prototype.clear = function () {
        ...
        this.columns.forEach(function (col) {
            _this.unforward.apply(_this, [col].concat(suffix('.ranking', Column.EVENT_DIRTY_VALUES, Column.EVENT_DIRTY_HEADER, Column.EVENT_DIRTY, NumberColumn.EVENT_FILTER_CHANGED)));
            col.detach();
        });

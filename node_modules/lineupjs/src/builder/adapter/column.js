...
export function build(props, _data) {
    ...
    ['label', 'description', 'frozen', 'color', 'width', 'renderer', 'groupRenderer', 'summaryRenderer', 'visible', 'fixed'].forEach(function (key) {
...
export function buildCategorical(props, data) {
    ...
    if (!props.categories) {
        var categories = new Set(data.map(function (d) { return d[desc.column]; }));
...
export function buildNumber(props, data) {
    ...
    var domain = props.domain ? props.domain : extent(data, function (d) { return d[desc.column]; });

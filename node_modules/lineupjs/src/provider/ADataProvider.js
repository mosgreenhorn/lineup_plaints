...
var ADataProvider = (function (_super) {
    ...
    ADataProvider.prototype.insertRanking = function (r, index) {
        ...
        this.forward.apply(this, [r].concat(suffix('.provider', Ranking.EVENT_ADD_COLUMN, Ranking.EVENT_REMOVE_COLUMN, Ranking.EVENT_DIRTY, Ranking.EVENT_DIRTY_HEADER, Ranking.EVENT_ORDER_CHANGED, Ranking.EVENT_DIRTY_VALUES)));
        var that = this;
    ...
    ADataProvider.prototype.removeRanking = function (ranking) {
        ...
        this.unforward.apply(this, [ranking].concat(suffix('.provider', Ranking.EVENT_ADD_COLUMN, Ranking.EVENT_REMOVE_COLUMN, Ranking.EVENT_DIRTY, Ranking.EVENT_DIRTY_HEADER, Ranking.EVENT_ORDER_CHANGED, Ranking.EVENT_DIRTY_VALUES)));
    ...
    ADataProvider.prototype.clearRankings = function () {
        ...
        this.rankings.forEach(function (ranking) {
            _this.unforward.apply(_this, [ranking].concat(suffix('.provider', Ranking.EVENT_ADD_COLUMN, Ranking.EVENT_REMOVE_COLUMN, Ranking.EVENT_DIRTY, Ranking.EVENT_DIRTY_HEADER, Ranking.EVENT_ORDER_CHANGED, Ranking.EVENT_DIRTY_VALUES)));
            ranking.on(Ranking.EVENT_DIRTY_ORDER + ".provider", null);
